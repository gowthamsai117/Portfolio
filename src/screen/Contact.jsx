...
//         <h2 className="text-3xl sm:text-4xl lg:text-5xl font-bold text-[#EBD3F8] mt-2">
//           Contact.
//         </h2>
//       </div>
...
//         {/* Form Section */}
//         <motion.div
//           className="w-full lg:w-1/2 bg-gradient-to-br from-purple-500 to-pink-500 rounded-[20px] transition-all duration-300 hover:shadow-[0_0_30px_1px_rgba(0,255,117,0.3)] order-2 lg:order-1"
//           variants={cardVariants}
//           initial="hidden"
//           animate="visible"
//         >
