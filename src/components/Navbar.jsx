...
//   return (
//     <nav className="bg-[#2E073F]/90 text-[#EBD3F8] p-4 shadow-md fixed w-full z-10 backdrop-blur-sm">

//       <div className="max-w-7xl mx-auto flex justify-between items-center gap-x-3">
//         <h1 className="text-2xl font-bold text-[#EBD3F8]">Gowtham</h1>

//         {/* Desktop Menu */}
//         <ul className="hidden md:flex space-x-4">
//           {["Home", "About", "Skills", "Projects", "Certifications", "Blogs", "Contact"].map((item) => (
//             <li key={item}>
//               <a
//                 href={`#${item.toLowerCase()}`} // Use anchor links
//                 className="px-4 py-2 border border-[#AD49E1] rounded-lg bg-[#3B0C59] 
//                 text-white transition duration-300 shadow-lg text-md
...
//           <button onClick={() => setIsOpen(!isOpen)} className="text-[#EBD3F8] focus:outline-none">
...
//       {/* Mobile Menu */}
//       {isOpen && (
//         <ul className="md:hidden gap-3 flex flex-col items-center bg-[#2E073F] py-4 space-y-3">
//           {["Home",  "About", "Skills", "Projects", "Certifications", "Blogs", "Contact"].map((item) => (
//             <li key={item}>
//               <a
//                 href={`#${item.toLowerCase()}`} // Use anchor links
